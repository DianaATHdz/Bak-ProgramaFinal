        ...
        boton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(pequeña==true){
                    ...
                    if(resultado>=1000){
                        res.setText("Gramos día("+String.valueOf(resultado1)+"paquete 1000 gramos($42.00), semana($294.00");
                    }
                    if(resultado<=400){
                    ...
                    if(resultado>500&&resultado<=600){
                        res.setText("Gramos al dia: "+String.valueOf(resultado1)+", " +
                                " res2.setTextpaquete 600 gramos($27.00), semana($189.00)");
                    }
                    ...
                    if(resultado>700&&resultado<=800){
                        res.setText("Gramos al dia: "+String.valueOf(resultado1)+"800 gramos($35.00), semana($245.00)");
                    }
